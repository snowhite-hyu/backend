...
public class CardInitializer {
    ...
    public void initializeCards() {
        List<Card> cardList = List.of(
                ...
                CardFactory.createPathCard(24, "path24", false, false, true, true, true),
                CardFactory.createPathCard(25, "path25", false, false, true, true, true),
                CardFactory.createPathCard(26, "path26", false, false, true, true, true),
                ...
                CardFactory.createPathCard(36, "path36", false, true, true, false, false),
                ...
                CardFactory.createDestinationCard(61, "destination1", true, false, true, false, true, false),
                CardFactory.createDestinationCard(62, "destination2", false, true, true, false, true, false),
                CardFactory.createDestinationCard(63, "destination3", true, true, true, true, true, true),
