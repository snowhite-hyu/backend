...
public class CardInitializer {
    ...
    public void initializeCards() {
        ...
        List<Card> cardList = List.of(
                ...
                new Card(103, "tool - pickaxe, lantern", CardType.ACTION),
                new Card(104, "tool - minecart", CardType.ACTION),
                new Card(105, "tool - minecart, pickaxe", CardType.ACTION),
                new Card(106, "tool - minecart, lantern", CardType.ACTION),
