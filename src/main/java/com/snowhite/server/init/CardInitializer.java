...
public class CardInitializer {
    ...
    public void initializeCards() {
        List<Card> cardList = List.of(
                ...
                CardFactory.createDestinationCard(61, "destination1", true, false, true, false, true),
                CardFactory.createDestinationCard(62, "destination2", false, true, true, false, true),
                CardFactory.createDestinationCard(63, "destination3", true, true, true, true, true),
